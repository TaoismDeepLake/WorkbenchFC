...
import com.deeplake.workbenchfc.item.IGuaEnhance;
import com.deeplake.workbenchfc.item.ItemSwordBase;
import com.deeplake.workbenchfc.util.IDLGeneral;
...
import static com.deeplake.workbenchfc.util.IDLSkillNBT.GetGuaEnhance;
...
//    public com.deeplake.workbenchfc.item.skills.martial.BuffTuple GetWaterBuff(ItemStack stack)
//    {
//        int water = GetGuaEnhance(stack, 2);
//        return new com.deeplake.workbenchfc.item.skills.martial.BuffTuple(water / 4, TICK_PER_SECOND * water * 2);
//    }
//
//    public com.deeplake.workbenchfc.item.skills.martial.BuffTuple GetMountainBuff(ItemStack stack)
//    {
//        int gua = GetGuaEnhance(stack, 4);
//        return new com.deeplake.workbenchfc.item.skills.martial.BuffTuple(gua / 4, TICK_PER_SECOND * gua * 2);
//    }
//
