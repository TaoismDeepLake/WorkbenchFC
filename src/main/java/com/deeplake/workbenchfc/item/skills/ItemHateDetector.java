...
import static com.deeplake.workbenchfc.util.NBTStrDef.IDLNBTDef.STATE;
import static com.deeplake.workbenchfc.util.NBTStrDef.IDLNBTUtil.GetInt;
import static com.deeplake.workbenchfc.util.NBTStrDef.IDLNBTUtil.SetInt;

public class ItemHateDetector extends ItemSkillBase {

    private Class<? extends EntityLiving> targetCategory = EntityLiving.class;
    private String msgKey = "workbenchfc.msg.being_targeted";
