package com.deeplake.workbenchfc.enchantments;
...
public class ModEnchantmentInit {
    ...
    //Example Enchant
//    public static final ModEnchantmentBase ANTI_VANILLA = new ModEnchantmentBase("workbenchfc.anti_vanilla", Enchantment.Rarity.UNCOMMON, EnumEnchantmentType.WEAPON,  mainHand)
