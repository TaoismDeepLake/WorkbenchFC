...
public class ModConfig {
    ...
    @Config.LangKey("configgui.workbenchfc.category.Menu0.GeneralConf")
...
//        @Config.LangKey("workbenchfc.conf.general.welcome")
//        @Config.Comment("The text shown when a player logs in. Can be a key or a string.")
//        public String WELCOME_MSG = "workbenchfc.msg.welcome";
    }

    @Config.LangKey("configgui.workbenchfc.category.Menu0.DebugConf")
    ...
    @Config.LangKey("configgui.workbenchfc.category.Menu0.SpawnConf")
