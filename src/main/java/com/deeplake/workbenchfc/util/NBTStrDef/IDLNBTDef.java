...
public class IDLNBTDef {
	...
	public static final String NAME_OFF= "workbenchfc.shared.off";
	public static final String NAME_ON= "workbenchfc.shared.on";
	...
	//gua socket
	public static final String GUA_NO_FREE_SOCKET_DESC = "workbenchfc.gua_enhance_no_free.desc";
	public static final String GUA_FREE_SOCKET_DESC = "workbenchfc.gua_enhance_free.desc";
	public static final String GUA_TOTAL_SOCKET_DESC = "workbenchfc.gua_enhance_total.desc";
	public static final String GUA_N_A_DESC = "workbenchfc.gua_not_applicable.desc";
	...
	public static final String KILL_COUNT_DESC = "workbenchfc.kill_count.desc";
