...
import com.deeplake.workbenchfc.entity.creatures.EntityModUnit;
...
import static com.deeplake.workbenchfc.util.NBTStrDef.IDLNBTDef.STRONG_TAG;
...
public class EntityUtil {
    ...
    static Item CHEST = Item.getItemFromBlock(Blocks.CHEST);
    static Item FURNACE = Item.getItemFromBlock(Blocks.FURNACE);
    static Item WORKBENCH = Item.getItemFromBlock(Blocks.CRAFTING_TABLE);

    public static int GetTypeAuto(EntityLivingBase entity)
    {
        if (entity instanceof EntityPlayer)
        {
            return IDLNBTUtil.GetIntAuto(entity, STRONG_TAG, 0);
        }
        else {
