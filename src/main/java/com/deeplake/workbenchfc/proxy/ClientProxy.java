package com.deeplake.workbenchfc.proxy;
...
public class ClientProxy extends ProxyBase {
	 ...
	 *   ������ַ���Ҳ�䵱�����ı��ػ�����
	 */
	//public static final KeyBinding CAST_MAINHAND = new ModKeyBinding("activate_skill_mainhand", KeyConflictContext.IN_GAME, KeyModifier.NONE, Keyboard.KEY_R, "key.category.workbenchfc");
	//public static final KeyBinding CAST_OFFHAND = new ModKeyBinding("activate_skill_offhand", KeyConflictContext.IN_GAME, KeyModifier.NONE, Keyboard.KEY_GRAVE, "key.category.workbenchfc");
